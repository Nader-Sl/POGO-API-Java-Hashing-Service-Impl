...
public class PokeHashReq implements Callable<PokeHashResp> {
    ...
    public PokeHashResp call() throws Exception {
        ...
        for (PokeHashReqHandler handler : handlers) {
            handler.onComplete(new PokeHashReqResult(resp, responseCode, rateLimitSecond, ratePeriodEnd, maxRequestCount, rateRequestsRemaining, (System.currentTimeMillis() - currTimeStamp)));
        }
        return resp;
    }
}
