...
public class PokeHashReq {
    ...
    public Observable<PokeHashReqResult> getResult() {
        try {
            ...
            return Observable.just(new PokeHashReqResult(resp, responseCode, rateLimitSecond, ratePeriodEnd, maxRequestCount, rateRequestsRemaining, (System.currentTimeMillis() - currTimeStamp)));
        } catch (Exception e) {
