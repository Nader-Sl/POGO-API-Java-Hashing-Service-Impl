...
public class HashingService {
    ...
    public final static int RPM = 60; //requests per minute
    public final static String POKE_HASH_KEY = "XXXXXX"; // Replace with hashing service key purchased from Bossland.
    ...
    public static void main(String[] argV) throws Exception {
        ...
        for (int i = 0; i < requestsSize; i++) {
            ...
            req.addHandler((resp, respCode, timeCost, rateLimitSecond, ratePeriodEnd, maxRequestCount, rateRequestsRemaining) -> {
                System.out.println(
                ...
                n,timeCost,(System.currentTimeMillis() - startTimeStamp),respCode,resp.toString(),rateLimitSecond,ratePeriodEnd,maxRequestCount,rateRequestsRemaining
                ));
            });
